package com.ouvrirdeveloper.basearc.helper.network
...
import com.ouvrirdeveloper.basearc.helper.network.base.ConnectivityProviderBaseImpl
        ...
        override fun onReceive(c: Context, intent: Intent) {
            ...
            val state: ConnectivityProvider.NetworkState =
                if (networkInfo?.isConnectedOrConnecting == true) {
                    ...
                    if (state != null) ConnectivityProvider.NetworkState.ConnectedState.ConnectedLegacy(state) else ConnectivityProvider.NetworkState.NotConnectedState
                }
